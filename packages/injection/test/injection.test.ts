import { type DiscordInstallation, getInstallations, inject, uninject } from "../src/index.js";
...
const targetChannels = new Set(["stable", "canary", "ptb", "development"]).intersection(
	new Set(args),
);
